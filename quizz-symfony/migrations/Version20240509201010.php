 ...
 */
final class Version20240509201010 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE new_quizz (id INT AUTO_INCREMENT NOT NULL, nom_quizz VARCHAR(255) NOT NULL, id_question INT NOT NULL, id_reponse INT NOT NULL, id_categorie INT NOT NULL, id_user INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
